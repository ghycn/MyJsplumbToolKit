(function () {
    ...
    var a = this, b = function (a, b, c) {
            ...
            return a
        }(), i = 10, j = 10, k = h > -1 && h < 9, l = 9 == h, m = function (a) {
    ...
    var a = this, b = a.jsPlumbUtil, c = function (a, b) {
        ...
        try {
            ...
            console.log("JSPLUMB: cannot set class list", a)
        }
    }, l = function (a) {
    ...
    var h = function (a, b) {
        ...
        }, this.detached = !1, this.id = a.id, this._jsPlumb.div = null, this._jsPlumb.initialised = !1, this._jsPlumb.component = a.component,
            this._jsPlumb.cachedDimensions = null, this._jsPlumb.create = a.create, this._jsPlumb.initiallyInvisible = a.visible === !1, this.getElement = function () {
    ...
    var c = function (a, b, c) {
        ...
        return this.execute = function (a, b) {
            ...
            return null == a || !b && q.indexOf(a) !== -1 || q.push(a), this
    ...
    E(D.prototype, {
        ...
        customElements: {
            "r-each": {
                ...
                parse: function (a, b, c, d) {
                    ...
                    try {
                        var b = this.children[0].bindings.__element.e[0][1];
                        return ";var __hp=_rotors.parse(data[0]." + b + "),__hc=_rotors.compile(__hp,true);var __f=__hc(data[0], _rotors);Rotors.peek(_els).appendChild(__f.childNodes[0]);"
                    } catch (b) {
        ...
        parse: function (a, b, c, d) {
            ...
            var e = [], g = [], h = this, i = function (a, b) {
                ...
                return h && (h.parse(g, b, c, d, e, f), h.compile && (g.compile = h.compile),
                    g.precompile = h.precompile, g.postcompile = h.postcompile, g.custom = !0, g.remove = h.remove, d.debug("  element is a custom element"), d.maybeDebug(g.remove, "  element's root should not appear in output")), g
            }, r = [{
    ...
    a.jsPlumbToolkitInstance = function (i) {
        ...
        var j = i.idFunction || h, k = i.typeProperty || f, l = i.edgeTypeProperty || f, m = i.portTypeProperty || f,
            n = i.typeFunction || function (a) {
                ...
                return a[m] || g
            }, s = i.portExtractor, t = i.portUpdater, u = this, v = !1, w = !1, x = i.model || {}, y = function (a, c, e) {
    ...
    }, this.jsPlumbToolkit.Methods = {addClass: "addClass", removeClass: "removeClass"}, this.jsPlumbToolkit.Events = {
    ...
    c.Circular = function (a) {
        ...
        this.defaultParameters = {padding: 30, locationFunction: a.locationFunction}, this.step = function (a, c) {
            ...
            for (i = 0; i < g.length; i++) if (j = g[i], e.setPosition(j.id, k + Math.sin(o) * m, l + Math.cos(o) * m, !0), o += n, i > 0) {
                var q = g[i - 1], r = e.getSize(q.id), s = e.getPosition(q.id),
                    t = {x: s[0] - c.padding, y: s[1] - c.padding, w: r[0] + 2 * c.padding, h: r[1] + 2 * c.padding},
                    u = g[i], v = e.getSize(u.id), w = e.getPosition(u.id),
    ...
    var m = b.DOMElementAdapter = function (a) {
        ...
        function m(a, b, c) {
            if (null == a.value("jtk-processed")) {
                ...
                var d = Ha(a, b, c), e = Q.addEndpoint(a.element, d);
                Ea[b.id + "." + d.portId] = e;
                var f = a.port || b.addPort({id: d.portId});
                e.graph = {node: b, port: f}, A.onUpdate(a.element, function () {
                })
            }
        }

        function n(a, b) {
            if (b.events) for (var c in b.events) Q.on(a, c, b.events[c])
        }
        ...
        function o(a, b, c) {
            if (null == a.value("jtk-processed")) {
                a.setValue("jtk-processed", !0);
                var d = Ha(a, b, c);
                null != d.portId && ($[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = C.addPort(b, {
                    id: d.portId,
                ...
                if ("true" === a.value("is-source") && (d.isSource = !0), delete d.uniqueEndpoint, delete d.createEndpoint, d.extract = {}, a.findDataValues(d.extract), "true" === a.value("endpoint")) {
                    ...
                    var i = Q.addEndpoint(a.element, d);
                    i.graph = {node: b}, Fa[b.id] = i, A.onUpdate(a.element, function () {
                    })
                } else {
                    var j, k = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
                    Q.makeSource(a.element, d);
                    var l = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
                    l > k && (j = a.element._katavorioDrop[a.element._katavorioDrop.length - 1]), A.onUpdate(a.element, function (a, c) {
                        var d = f.getSelector(a, "jtk-source");
                        if (1 === d.length) {
                            var e = Ha(d[0], b);
                            e.scope && (Q.setSourceScope(a, e.scope, e.edgeType), j && j.k.setDropScope(j, e.scope))
                        }
                    })
                }
            }
        ...
        function p(a, b, c) {
            if (null == a.value("jtk-processed")) {
                a.setValue("jtk-processed", !0);
                var d = Ha(a, b, c);
                if (null != d.portId && ($[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = C.addPort(b, {
                        id: d.portId,
                        type: d.portType || "default"
                    }, !0), n(a.element, d)), "true" === a.value("is-target") && (d.isTarget = !0), delete d.uniqueEndpoint, delete d.createEndpoint, "true" === a.value("endpoint")) {
                    d.maxConnections = -1, d.isTarget = !0;
                    var e = Q.addEndpoint(a.element, d);
                    e.graph = {node: b}, Ga[b.id] = e, A.onUpdate(a.element, function () {
                    })
                } else {
                    Q.makeTarget(a.element, d);
                    var g = a.element._katavorioDrop[a.element._katavorioDrop.length - 1];
                    A.onUpdate(a.element, function (a, c) {
        ...
        function s(a, b, c) {
            ...
            if (d) {
                var e = !b || q(d);
                e && (d.setVisible(b), c || (r(d, d.endpoints[0], b), r(d, d.endpoints[1], b)))
            }
        }
        ...
        function t(a, b) {
            ...
            if (a.eachNode && a.eachEdge) c = {nodes: [], edges: []}, a.eachNode(function (a, d) {
                ...
                c = [];
                for (var d = 0; d < a.length; d++) c.push(b(u(a[d])))
            } else c = b(u(a));
            return c
        }

        function u(a) {
            return a instanceof Q.getDefaultConnectionType() && (a = a.edge), C.getObjectInfo(a, function (a) {
                return a.getNode ? $[a.getFullId()] || Y[a.getNode().id] : Y[a.id] || _[a.id]
            })
        }
        ...
        var v = function (a, b) {
            ...
            }, w = '<div data-jtk-node-id="${id}" class="' + j.NODE + '"></div>', x = {
                rotors: {
                    render: function (a, b) {
                        return A.template(a, b).childNodes[0]
                    }
                }
            }, y = "rotors", z = a.debug === !0,
            A = g.newInstance({defaultTemplate: w, templateResolver: a.templateResolver, templates: a.templates}),
            B = this, C = a.toolkit, D = new c.Layouts.EmptyLayout(B), E = f.getElement(a.container),
            F = !(a.elementsDraggable === !1), G = a.elementsDroppable === !0, H = !1,
            I = a.refreshAutomatically !== !1,
            J = a.templateRenderer ? e.isString(a.templateRenderer) ? x[a.templateRenderer] : {render: a.templateRenderer} : x[y],
            K = a.enhancedView !== !1, L = a.assignPosse || function () {
                return null
            }, M = a.modelLeftAttribute || "left", N = a.modelTopAttribute || "top", O = a.storePositionsInModel !== !1,
            P = e.merge(a.jsPlumb || {}), Q = a.jsPlumbInstance || f.getInstance(P, a.overrideFns), R = Q.getId(E);
        Q.bind("beforeDrop", function (a) {
            ...
            return null == g ? C.beforeConnect(e, f, a.connection.getData()) : C.beforeMoveConnection(e, f, g)
        }), Q.bind("beforeDrag", function (a) {
            var b = a.endpoint.graph || a.source.jtk, c = b.port || b.node, d = a.endpoint.connectionType,
                e = C.beforeStartConnect(c, d);
            if (z) {
                var f = va.getEdgeDefinition(d) || {};
                ...
                var g = va["get" + c.objectType + "Definition"](c.getType()) || {};
                console.log(g), console.log("Toolkit response to drag start :"), console.log(e), console.log("---------------------------\n")
            }
            return e === !1 && a.endpoint.isTemporarySource && a.endpoint._deleteOnDetach && Q.deleteEndpoint(a.endpoint), e
        }), Q.bind("beforeDetach", function (a, b) {
            var c = a.endpoints[0].graph || a.source.jtk, d = a.endpoints[1].graph || a.target.jtk,
                e = c.port || c.node, f = d.port || d.node, g = a.edge;
            return C.beforeDetach(e, f, g, b)
        }), Q.bind("beforeStartDetach", function (a) {
            var b = a.endpoint.graph || a.source.jtk, c = b.port || b.node, d = a.connection.edge;
            return C.beforeStartDetach(c, d)
        }), Q.bind("connectionEdit", function (a) {
            a.edge && (a.edge.geometry = a.getConnector().getGeometry())
        }), e.EventGenerator.apply(this, arguments), a.activeFiltering && new c.UI.ActiveDragFilter(B, Q, C), this.setDebug = function (a) {
        ...
        var S = [l.canvasClick, l.canvasDblClick, l.nodeAdded, l.nodeDropped, l.nodeRemoved, l.nodeRendered, l.groupAdded, l.groupRemoved, l.groupMoveEnd, l.groupMemberAdded, l.groupMemberRemoved, l.groupCollapse, l.groupExpand, l.nodeMoveStart, l.nodeMoveEnd, l.portAdded, l.portRemoved, l.edgeAdded, l.edgeRemoved, l.edgeTypeChanged, l.nodeTypeChanged, l.portTypeChanged, l.dataLoadEnd, l.anchorChanged, l.objectRepainted, l.modeChanged, l.lassoEnd, l.pan, l.zoom, l.relayout, l.click, l.tap, l.stateRestored, l.startOverlayAnimation, l.endOverlayAnimation, l.nodeVisibility],
            T = B.bind, U = Q.bind;
        if (this.setHoverSuspended = Q.setHoverSuspended, this.isHoverSuspended = Q.isHoverSuspended, this.setJsPlumbDefaults = function (a) {
                delete a.Container, Q.restoreDefaults(), Q.importDefaults(a)
            }, this.bind = function (a, b) {
                S.indexOf(a) == -1 ? U(a, b) : T(a, b)
            }, a.events) for (var V in a.events) this.bind(V, a.events[V]);
        if (a.interceptors) for (var W in a.interceptors) this.bind(W, a.interceptors[W]);
        var X = !1;
        U(l.connection, function (a) {
            if (null == a.connection.edge) {
                a.sourceEndpoint.getParameter("nodeId") || a.sourceEndpoint.setParameter("nodeId", Z[a.sourceEndpoint.elementId].id), a.targetEndpoint.getParameter("nodeId") || a.targetEndpoint.setParameter("nodeId", Z[a.targetEndpoint.elementId].id);
                var b = a.sourceEndpoint.getParameter("portType"), c = va.getPortDefinition(b),
                    ...
                    i = e + (f ? "." + f : ""), j = g + (h ? "." + h : ""), k = {
                        ...
                        sourceId: i,
                        targetId: j
                    }, m = C.getEdgeFactory()(d, a.connection.getData() || {}, function (b) {
                        k.edge = C.addEdge({
                            source: i,
                            target: j,
                            ...
                            data: b,
                            addedByMouse: !0
                        }, B), ea[k.edge.getId()] = a.connection, a.connection.edge = k.edge, ia(d, k.edge, a.connection), k.addedByMouse = !0, k.connection = a.connection, B.fire(l.edgeAdded, k)
                    });
                m === !1 && Q.deleteConnection(a.connection)
            }
        }), U(l.connectionMoved, function (a) {
            var c = 0 === a.index ? a.newSourceEndpoint : a.newTargetEndpoint, d = c.graph || c.element.jtk;
            b(function () {
                C.edgeMoved(a.connection.edge, d.port || d.node || d.group, a.index)
            })
        }), U(l.connectionDetached, function (a) {
            b(function () {
                C.removeEdge(a.connection.edge)
            });
        ...
        }), U(l.groupDragStop, function (a) {
            B.getLayout().setPosition(a.group.id, a.pos[0], a.pos[1], !0), a.uigroup = a.group, B.fire(l.groupMoveEnd, f.extend(a, {group: C.getGroup(a.uigroup.id)}))
        }), U(l.groupMemberAdded, function (a) {
            if (!H && a.el.jtk.node) {
                var b = C.addToGroup(a.el.jtk.node, a.group.id);
                b && B.fire(l.groupMemberAdded, {node: a.el.jtk.node, group: b, uigroup: a.group}), qa()
            }
        }), U(l.groupMemberRemoved, function (a) {
            if (!H && a.el.jtk.node) {
                var b = C.removeFromGroup(a.el.jtk.node);
                b && (B.nodeRemovedFromGroup(a.el), B.fire(l.groupMemberRemoved, {
                    node: a.el.jtk.node,
                    ugroup: b,
                    igroup: a.group
                })), qa()
            }
        }), U(l.groupCollapse, function (a) {
            var b = C.getGroup(a.group.id);
            b && B.fire(l.groupCollapse, {group: b, uigroup: a.group})
        }), U(l.groupExpand, function (a) {
            var b = C.getGroup(a.group.id);
            b && B.fire(l.groupExpand, {group: b, uigroup: a.group})
        });
        var Y = {}, Z = {}, $ = {}, _ = {}, aa = [], ba = {}, ca = [], da = function (a) {
            var b = ca.indexOf(a);
            b !== -1 && ca.splice(b, 1)
        };
        this.getNodeCount = function () {
        ...
        var ea = {}, fa = function (a) {
            return ea[a.getId()]
        }, ga = function (a) {
            for (var b = [], c = 0; c < a.length; c++) b.push(ea[a[c].getId()]);
            return b
        }, ha = function (a, b, c, d) {
            d.bind(a, function (a, e) {
                b.apply(b, [{edge: c, e: e, connection: d, toolkit: C, renderer: B}])
            })
        }, ia = function (a, b, c) {
            if (!c.getParameter("edge")) {
                var d = va.getEdgeDefinition(a);
                if (d && d.events) for (var e in d.events) ha(e, d.events[e], b, c)
            }
        }, ja = function (a) {
            B.fire(l.edgeRemoved, {
        ...
        this.setSuspendRendering = function (a, b) {
            H = a, Q.setSuspendDrawing(a), b && this.refresh()
        }, this.batch = function (a) {
            this.setSuspendEvents(!0), C.batch(a), this.setSuspendEvents(!1)
        };
        var ka = function (a, b) {
            if (H) ma.push([a, b]); else {
                var c = L(b);
                if (null != c) {
                    var d = e.isArray(c) ? c : [c];
                    d.unshift(a), Q.addToPosse.apply(Q, d)
                }
            }
        }, la = function () {
            for (var a = 0; a < ma.length; a++) ka.apply(this, ma[a])
        }, ma = [];
        if (this.bindToolkitEvents !== !1) {
            var na = function () {
                ma.length = 0, Q.setSuspendDrawing(!0), this.setSuspendRendering(!0)
            }.bind(this);
            C.bind(l.dataLoadStart, na), C.bind(l.dataAppendStart, na), C.bind(l.dataLoadEnd, function () {
                this.setSuspendRendering(!1), la(), Q.getGroupManager().refreshAllGroups(), ta(), B.relayout(), Q.setSuspendDrawing(!1, !0), D && B.fire(l.dataLoadEnd)
            }.bind(this)), C.bind(l.dataAppendEnd, function () {
                this.setSuspendRendering(!1), la(), B.refresh(), Q.setSuspendDrawing(!1, !0), D && B.fire(l.dataAppendEnd)
            }.bind(this));
            var oa = function (a, b, c) {
                var d = _[c.id];
                if (d) {
                    var e = d.querySelector("[jtk-group-content]") || d;
                    e.appendChild(a), Q.addToGroup(c.id, a, !0), B.nodeAppendedToGroup(a, d, c)
                }
            }, pa = function (a, b) {
                var c = Y[a.id];
                if (null == c) {
                    var d = va.getNodeDefinition(C.getNodeType(a.data));
                    if (d.ignore === !0) return !1;
                    if (c = Aa(a, a.data, a), !c) throw new Error("Cannot render node");
                    var e = Q.getId(c);
                    Y[a.id] = c, Z[e] = a, ca.push(a), c.jtk = {node: a}, null == a.group ? B.append(c, e, b ? b.position : null) : oa(c, a, a.group), ka(c, a), Ka(c, a);
                    var f = {node: a, el: c, id: a.id};
                    B.getLayout().nodeAdded(f, b), B.fire(l.nodeAdded, f)
                }
                return c
            };
            C.bind(l.nodeAdded, function (a) {
                var b, c = a.node, d = pa(c, a.eventInfo);
                if (null != d) {
                    var e = Q.getSelector(d, "[data-port-id]");
                    for (b = 0; b < e.length; b++) {
                        var f = e[b].getAttribute("data-port-id");
                        $[c.id + "." + f] = e[b], e[b].jtk = e[b].jtk || {node: c, port: c.getPort(f)}
                    }
                    B.refresh(!0)
                }
            }), C.bind(l.nodeRemoved, function (a) {
                B.getLayout().nodeRemoved(a.nodeId);
                var b = Y[a.nodeId];
                B.fire(l.nodeRemoved, {node: a.nodeId, el: b});
                var c = Q.getId(b);
                A.remove(b), Q.remove(b), delete Y[a.nodeId], delete Fa[a.nodeId], delete Ga[a.nodeId], delete Z[c], da(a.node), delete b.jtk, B.refresh(!0)
            });
            var qa = function () {
                a.relayoutOnGroupUpdate && B.relayout()
            };
            C.bind("group:addMember", qa), C.bind("group:removeMember", qa);
            var ra = function (b, c) {
                var d = _[b.id];
                if (null == d) {
                    var g = va.getGroupDefinition(C.getNodeType(b.data));
                    if (g.ignore === !0) return !1;
                    if (d = Ca(b, b.data, b), !d) throw new Error("Cannot render Group");
                    var h = Q.getId(d);
                    _[b.id] = d, aa.push(b), ba[h] = b, d.jtk = {group: b}, B.append(d, h, c ? c.position : null), ka(d, b), Ka(d, b);
                    ...
                    f.extend(j, {dragOptions: a.dragOptions || {}}), j.dragOptions[f.dragEvents[k.stop]] = e.wrap(j.dragOptions[f.dragEvents[k.stop]], function (a) {
                        a.el.jtk && a.el.jtk.group && (j.dragOptions.magnetize ? a.pos = B.getLayout().setMagnetizedPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0) : B.getLayout().setPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0), O !== !1 && (B.storePositionInModel({
                            id: a.el.jtk.group.id,
                            group: !0,
                            leftAttribute: M,
                            topAttribute: N
                        }), C.fire(l.groupUpdated, {group: a.el.jtk.group}, null)), B.fire(l.groupMoveEnd, {
                            el: a.el,
                    ...
                    }), Q.addGroup(f.extend(j, g)), B.getLayout().groupAdded({
                        group: b,
                        el: d,
                        id: b.id
                    }, c), B.fire(l.groupAdded, i)
                }
                return d
            };
            C.bind(l.groupAdded, function (a) {
                var b = a.group, c = ra(b, a.eventInfo);
                null != c && B.refresh(!0)
            }), C.bind(l.groupRemoved, function (a) {
                var b = a.group;
                B.getLayout().groupRemoved(b.id);
                var c = _[b.id], d = Q.getId(c);
                Q.removeGroup(b.id, a.removeChildNodes, !0, !1), delete _[b.id], delete ba[d], delete c.jtk, B.refresh(!0)
            }), this.expandGroup = function (a) {
                Q.expandGroup("string " == typeof a ? a : a.id)
            }, this.collapseGroup = function (a) {
                Q.collapseGroup("string " == typeof a ? a : a.id)
            }, this.toggleGroup = function (a) {
                Q.toggleGroup("string " == typeof a ? a : a.id)
            };
            var sa = function (a, b) {
                for (var c, d, e = a.getNodes(), f = 0, g = 0, h = B.getLayout(), i = Q.getGroup(a.id), j = i.getDragArea(), k = b.autoSizePadding || [10, 10], l = 0; l < e.length; l++) c = h.getPosition(e[l].id), isNaN(c[0]) || isNaN(c[1]) || (d = h.getSize(e[l].id), f = Math.max(f, c[0] + d[0] + k[0]), g = Math.max(g, c[1] + d[1] + k[1]));
                ...
                for (var a in _) {
                    var b = C.getGroup(a);
                    if (b) {
                        var c = va.getGroupDefinition(C.getNodeType(b.data));
                        c.autoSize && sa(b, c)
                    }
                }
            };
            ...
            var ua = function (b, c) {
                return function () {
                    var d = ya(b);
                    d.doNotFireConnectionEvent = !0, c && (d.geometry = c), C.isDebugEnabled() && console.log("Renderer", "adding edge with params", d);
                    var e = Q.connect(d);
                    e.edge = b, ea[b.getId()] = e, ia(d.type, b, e), B.fire(l.edgeAdded, {
                        source: b.source,
                        target: b.target,
                        connection: e,
                        edge: b,
                        geometry: c
                    }), a.refreshLayoutOnEdgeConnect && B.refresh(!0);
                    var f = b.source.getNode ? b.source.getNode() : b.source, g = Y[f.id],
                        h = b.target.getNode ? b.target.getNode() : b.target, i = Y[h.id];
                    i._jtkVisible !== !1 && g._jtkVisible !== !1 || s(b, !1)
                }
            };
            C.bind(l.edgeAdded, function (b) {
                if (!X && b.source !== B) {
                    var c = b.edge, d = va.getEdgeDefinition(C.getEdgeType(c.data || {}));
                    if (d && d.ignore === !0) return;
                    var e = ua(c, b.geometry);
                    a.connectionHandler ? a.connectionHandler(c, e) : e()
                }
            }), C.bind(l.edgeRemoved, function (a) {
                if (!X && a.source !== B) {
                    var b = a.edge, c = ea[b.getId()];
                    c && (C.isDebugEnabled() && console.log("Renderer", "removing edge", b), ja(b), delete ea[b.getId()], null != c._jsPlumb && Q.deleteConnection(c, {fireEvent: !1}))
                }
            }), C.bind(l.edgeTypeChanged, function (a) {
                if (!X && a.source !== B) {
                    var b = a.obj, c = ea[b.getId()];
                    if (c) {
                        var d = va.getEdgeDefinition(a.newType);
                        if (d && d.ignore === !0) return;
                        d.connector && c.setConnector(d.connector), c.setType(a.newType, b.data)
                    }
                }
            }), C.bind(l.edgeTarget, function (a) {
                if (!X) {
                    var b = a.edge, c = ea[b.getId()], d = Y[b.target.getFullId()];
                    c ? Q.silently(function () {
                        null != d ? (C.isDebugEnabled() && console.log("target change", c), Q.setTarget(c, d)) : (delete ea[b.getId()], Q.detach({
                            connection: c,
                            forceDetach: !0,
                            fireEvent: !1
                        }))
                    }) : null != d && C.isDebugEnabled() && e.log("Target for Edge " + b.getId() + " changed to Node " + d.id + "; we have no valid connection.")
                }
            }), C.bind(l.edgeSource, function (a) {
                if (!X) {
                    var b = a.edge, c = ea[b.getId()], d = Y[b.source.getFullId()];
                    c ? Q.silently(function () {
                        null != d ? Q.setSource(c, d) : (delete ea[b.getId()], Q.detach({
                            connection: c,
                            forceDetach: !0,
                            fireEvent: !1
                        }))
                    }) : null != d && C.isDebugEnabled() && e.log("Source for Edge " + b.getId() + " changed to Node " + d.id + "; we have no valid connection.")
                }
            }), C.bind("graphClearStart", function () {
                for (var a in _) "undefined" != typeof _[a]._rotors && A.remove(_[a]), Q.silently(function () {
                    Q.getGroupManager().removeGroup(a)
                }), delete _[a].jtk;
                for (var b in Y) "undefined" != typeof Y[b]._rotors && A.remove(Y[b]), Q.remove(Y[b], !0), delete Y[b].jtk;
                D && D.clear(), Q.setSuspendEvents(!0), Q.batch(Q.deleteEveryEndpoint, !0), Q.setSuspendEvents(!1), ca.length = 0, aa.length = 0, ea = {}, Y = {}, _ = {}, Z = {}, ba = {}, $ = {}, Ea = {}
            }), C.bind(l.portAdded, function (a) {
                var b = Y[a.node.id] || _[a.node.id], c = va.getPortDefinition(C.getPortType(a.data));
                if (c.isEndpoint) m(new Ja(a.data, b, a.port), a.node); else {
                    var d = Ba(a.port, a.data, a.node);
                    $[a.node.id + C.getGraph().getPortSeparator() + a.port.id] = d, Ka(Q.getElement(d), a.node), B.fire(l.portAdded, {
                        node: a.node,
                        nodeEl: b,
                        port: a.port,
                        portEl: d
                ...
                Q.recalculateOffsets(b), B.refresh(!0)
            }), C.bind(l.portRemoved, function (a) {
                var b = Y[a.node.id] || _[a.node.id], c = a.node.id + "." + a.port.id, d = $[c];
                Q.setSuspendEvents(!0), Q.remove(d), Q.setSuspendEvents(!1), delete $[c], B.fire(l.portRemoved, {
                    node: a.node,
                    port: a.port,
                    portEl: d,
                    nodeEl: b
                }), Q.recalculateOffsets(b), B.refresh(!0)
            }), C.bind(l.edgeUpdated, function (a) {
                var b = ea[a.edge.getId()];
                if (b) {
                    var c = ya(a.edge);
                    b.setType(c.type, c.data)
                }
            }), C.bind(l.portUpdated, function (a) {
                var b = $[a.port.getFullId()];
                b && (A.update(b, a.port.data), B.repaint(Y[a.node.id]))
            }), C.bind(l.nodeUpdated, function (a) {
                var b = Y[a.node.getFullId()];
                if (b) {
                    A.update(b, a.node.data), Ka(b, a.node);
                    var c = L(a.node);
                    if (null != c) {
                        var d = e.isArray(c) ? c : [c];
                        d.unshift(b), Q.setPosse.apply(Q, d)
                    } else Q.removeFromAllPosses(b);
                    B.repaint(b)
                }
            })
        }
        ...
        this.setView = function (a) {
            var b = e.merge(C.getModel(), a || {});
            va = new c.Model(b, Q)
        }, this.setView(a.view), this.getView = function () {
            return va
        };
        var wa = [], xa = function (a) {
            return null == a ? C : "string" == typeof a ? C.select(a, !0) : a.jtk ? C.select(a.jtk.port || a.jtk.node, !0) : a
        };
        this.activateState = function (a, b) {
            var c = va.getState(a);
            c && (b = xa(b), c.activate(b, B, C), wa.push(c))
        }, this.deactivateState = function (a, b) {
            var c = va.getState(a);
            c && (b = xa(b), c.deactivate(b, B, C), e.removeWithFunction(wa, function (a) {
                return a == c
            }))
        }, this.resetState = function () {
            for (var a = 0; a < wa.length; a++) wa[a].deactivate(C, B, C);
            wa.length = 0
        };
        var ya = function (a) {
                var b = C.getEdgeType(a.data),
                    c = {type: b, connectionType: b, data: a.data, cost: a.getCost(), directed: a.isDirected()},
                    d = va.getEdgeDefinition(b);
                !function (a) {
                ...
                var e = function (a, b, c, d, e) {
                    ...
                    if (a[b].getNode) {
                        var f = a[b].getNode(), g = a[b].getFullId(), h = Ea[g] || $[g];
                        null != h ? c[b] = h : c[b] = $[g], null == c[b] && (c[b] = Y[C.getNodeId(f.data)]);
                        var i = va.getPortDefinition(a[b].getType());
                        e(c, "anchors", "anchor", i, d), e(c, "endpoints", "endpoint", i, d)
                    } else {
                        var j = C.getNodeId(a[b].data), h = 0 === d ? Fa[j] : Ga[j];
                        c[b] = null == h ? Y[j] || _[j] : h
                    }
                };
                return f("source", 0), f("target", 1), c
            }, za = function (a, b, c, d, e, g, h, i) {
                return function (j, k, l) {
                    var m, n = b(k), o = null, p = c(k), q = va[d](p), r = k;
                    if (K) {
                    ...
                    if (q) {
                        ...
                        o = q.templateRenderer ? q.templateRenderer(t, r, C, a) : J.render(t, r, C, a)
                    } else o = e(r, n);
                    o = Q.getElement(o), o.setAttribute(i, n), f.addClass(o, h), o.jtk = o.jtk || {}, o.jtk[a] = j, o.jtk.node = l, g && F && Ma.makeDraggable && Ma.makeDraggable(o, q.dragOptions), G && Ma.makeDroppable && Ma.makeDroppable(o, q.dropOptions);
                    var u = function (a) {
                        Q.on(o, a, function (b) {
                            q.events[a]({node: l, el: o, e: b, toolkit: C, renderer: B})
                        })
                    };
                    if (q && q.events) for (m in q.events) u(m);
                    return o
                }
            }, Aa = za("node", C.getNodeId, C.getNodeType, "getNodeDefinition", v, !0, j.NODE, h.NODE),
            Ba = za("port", C.getPortId, C.getPortType, "getPortDefinition", v, !1, j.PORT, h.PORT),
            Ca = za("group", C.getNodeId, C.getNodeType, "getGroupDefinition", v, !1, j.GROUP, h.GROUP);
        this.initialize = function () {
            var b, c, d, e, f;
            if (C.setSuspendGraph(!0), Q.setSuspendDrawing(!0), a.jsPlumbInstance) {
                ...
                for (var h in c) {
                    var i = c[h].el;
                    Y[i.jtk.node.id] = i, Z[a.jsPlumbInstance.getId(i)] = i.jtk.node
                }
                Ma.doImport && Ma.doImport(Y, ea)
            } else {
                for (b = 0, d = C.getGroupCount(); b < d; b++) e = C.getGroupAt(b), ra(e);
                for (b = 0, d = C.getNodeCount(); b < d; b++) c = C.getNodeAt(b), pa(c);
                for (b = 0, d = C.getNodeCount(); b < d; b++) if (c = C.getNodeAt(b), Y[c.id]) {
                    var j = C.getAllEdgesFor(c);
                    for (f = 0; f < j.length; f++) if (j[f].source == c || j[f].source.getNode && j[f].source.getNode() == c) {
                        var k = va.getEdgeDefinition(C.getNodeType(j[f].data));
                        if (k && k.ignore === !0) continue;
                        var l = ya(j[f]);
                        l.doNotFireConnectionEvent = !0;
                        var m = Q.connect(l);
                        null != m && (m.edge = j[f], ea[j[f].getId()] = m, ia(l.type, j[f], m))
                    }
                }
            }
            ta(), this.relayout(), Q.setSuspendDrawing(!1, !0), C.setSuspendGraph(!1)
        }, this.getContainer = function () {
            return E
            ...
            if (null == a) return null;
            var b = a.getFullId();
            return "Port" === a.objectType ? $[b] : "Group" === a.objectType ? _[b] : Y[b]
            ...
            var b = u(a), c = null;
            return b && b.obj && "Port" === b.obj.objectType && Q.selectEndpoints({element: b.el}).each(function (a) {
                a.graph && a.graph.port && a.graph.port === b.obj && (c = a)
            }), c
        };
        var Da = function (a) {
            var b = Q.extend({
                container: E, getElementForNode: function (a) {
                    return Y[a] || _[a]
                }
            }, a);
            if (b.jsPlumbToolkit = C, b.adapter = B, !c.Layouts[b.type]) throw"no such layout [" + b.type + "]";
            return b.locationFunction || (b.locationFunction = function (a) {
                return [g.data(a.data, M), g.data(a.data, N)]
            }), new c.Layouts[b.type](b)
        };
        this.adHocLayout = function (a) {
            if (a) {
                var b = D;
                this.setLayout(a), D = b
            }
            ...
            return null != D ? D.getMagnetizedElements() : []
        }, this.magnetize = function (a) {
            null != D && D.magnetize(a)
        }, this.refresh = function (a) {
            H || a && !I || (D ? D.layout(function () {
                "undefined" != typeof window ? window.setTimeout(Q.repaintEverything, 0) : Q.repaintEverything()
            }) : Q.repaintEverything())
        }, this.setRefreshAutomatically = function (a) {
            I = a
        }, this.relayout = function (a) {
            H || (D ? D.relayout(a, function () {
                Q.repaintEverything(), this.fire("relayout", this.getBoundsInfo())
            }.bind(this)) : Q.repaintEverything())
            ...
            return Q.getSize(u(a).el)
        }, this.getCoordinates = function (a) {
            var b = this.getLayout();
            if (b) {
                var c = u(a), d = b.getPosition(c.id), e = Q.getSize(c.el);
                return {x: d[0], y: d[1], w: e[0], h: e[1]}
            }
        };
        var Ea = {}, Fa = {}, Ga = {}, Ha = function (a, b, c) {
            var g = a.value("port-id"), h = a.value("port-type") || "default",
                i = a.value("scope") || Q.getDefaultScope(), j = C.getNodeType(b), k = va.getNodeDefinition(j),
                l = va.getPortDefinition(g, k), m = va.getPortDefinition(h, k), n = e.merge(m, l),
                o = null == n ? {} : d.populate(n, b.data), p = function (a) {
                    ...
                    return function (b) {
                        var c = [{connection: b.connection || b, source: u(b.source), target: u(b.target), scope: b.scope}];
                        return a.apply(a, c)
                    }
                ...
                }, t = va.getEdgeDefinition(r);
            if (t) for (var v in t) {
                var w = s[v] || v;
                null == o[w] && (o[w] = t[v])
            }
            if (o.connectionType = r, o.portId = g, o.portType = h, o.scope = i, o.parameters = o.parameters || {}, o.parameters.portId = g, o.parameters.portType = h, o.parameters.edgeType = r, o.parameters.scope = i, o.parameters.nodeId = b.id, o.events = {}, n.events) for (v in n.events) o.events[v] = p(n.events[v]);
            if (n.interceptors) for (v in n.interceptors) o[v] = q(n.interceptors[v]);
            var x = a.value("anchor-x"), y = a.value("anchor-y"), z = a.value("orientation-x"),
                A = a.value("orientation-y"), D = a.value("offset-x"), E = a.value("offset-y");
            return null != x && null != y && (o.anchor = [parseFloat(x), parseFloat(y), parseInt(z || "0", 10), parseInt(A || "0", 10), parseFloat(D || "0"), parseFloat(E || "0")]), f.extend(o, c || {}), o.events.anchorChanged = function (a) {
                B.fire("anchorChanged", {
                    portId: g,
                    nodeId: b.id,
                    portType: h,
                    node: b,
            ...
            for (c = 0; c < g.length; c++) d = new Ia(g[c]), o(d, b);
            for (c = 0; c < h.length; c++) d = new Ia(h[c]), p(d, b);
            for (c = 0; c < e.length; c++) d = new Ia(e[c]), m(d, b)
        };
        this.setLayout(a.layout, !0), this.storePositionsInModel = function (a) {
            a = a || {};
            var b = a.leftAttribute || "left", c = a.topAttribute || "top", d = D.getPositions();
            for (var e in d) {
                var f = C.getNode(e) || C.getGroup(e);
            ...
            var b = "string" == typeof a ? a : a.id, c = "string" == typeof a ? "left" : a.leftAttribute || "left",
                d = "string" == typeof a ? "top" : a.topAttribute || "top", e = D.getPosition(b),
                f = C[a.group ? "getGroup" : "getNode"](b);
            return f && (g.data(f.data, c, e[0]), g.data(f.data, d, e[1])), e
        };
        var La = function (a, b, c, d, e, f, g) {
            return a = a || u(b), a && (D.setPosition(a.id, c, d), e || (Q.setAbsolutePosition(a.el, [c, d], f, g), Q.revalidate(a.el))), a
        };
        this.setPosition = function (a, b, c, d) {
            ...
            return t(a, function (a) {
                switch (a.type) {
                    ...
                    case"Node":
                        return a.el._jtkVisible
                }
            })
        }, this.setVisible = function (a, b, c) {
            if (null != a) {
                var d = function (a, d) {
                    if (d && (d.style.display = b ? "block" : "none", d._jtkVisible = b, B.fire(l.nodeVisibility, {
                            node: a,
                            el: d,
                            state: b
                        }), !c)) for (var e = C.getAllEdgesFor(a), f = 0; f < e.length; f++) s(e[f], b, c)
                }, e = function (a) {
            ...
            d.each(a, function (a) {
                var d = u(a);
                d.el && Q.addToPosse(d.el, {id: b, active: c !== !1})
            })
        }, this.setPosse = function (a, b) {
            d.each(a, function (a) {
                var c = u(a);
                c.el && Q.setPosse(c.el, b)
            })
        }, this.removeFromPosse = function (a, b) {
            d.each(a, function (a) {
                var c = u(a);
                c.el && Q.removeFromPosse(c.el, b)
            })
        }, this.removeFromAllPosses = function (a) {
            d.each(a, function (a) {
                var b = u(a);
                b.el && Q.removeFromAllPosses(b.el)
            })
        }, this.setPosseState = function (a, b, c) {
            d.each(a, function (a) {
                var d = u(a);
                d.el && Q.setPosseState(d.el, b, c)
            })
        };
        var Ma = {
            jsPlumb: Q,
            ...
            container: E,
            containerId: R,
            getConnectionsForEdges: ga,
            getConnectionForEdge: fa,
            getElement: function (a) {
                return Y[a] || _[a]
            },
    ...
    this.ZoomWidget = function (a) {
        ...
        var i, j, k, l, m, n, o = this, p = function () {
            ...
            H = a.wheelFilter || function () {
                return !0
            }, I = a.wheelZoomMetaKey === !0, J = a.wheelReverse === !0 ? -1 : 1, K = J * (a.wheelSensitivity || 10),
            L = a.enablePanButtons !== !1, M = a.padding || [0, 0], N = a.consumeRightClick !== !1,
            O = a.smartMinimumZoom, P = !1, Q = "mousedown", R = "mouseup", S = "mousemove",
            T = ["webkit", "Moz", "ms"], U = a.bind, V = a.unbind, W = !(a.enabled === !1), X = a.clampToBackground,
            Y = a.clampToBackgroundExtents, Z = a.filter || function (a) {
                return !1
            }, $ = a.width, _ = a.height, aa = 0, ba = 0, ca = a.zoom || 1, da = [0, 0], ea = !1, fa = !1, ga = !1, ha = !1,
            ia = a.zoomRange || [.05, 3], ja = 150, ka = -1, la = -1, ma = {minx: [], maxx: [], miny: [], maxy: []},
        ...
        }), Pa(ca, null, !1, !1, !0), Ga(), this.isPinchZooming = function () {
            return fa
    ...
    c.Surface = function (a) {
        ...
        var n, o = d.getElement(a.container), p = c.createElement({
            ...
            t = a.dropOptions || {}, u = a.stateHandle, v = a.storePositionsInModel !== !1, w = a.modelLeftAttribute,
            x = a.modelTopAttribute, y = new ZoomWidget({
                viewport: o,
                canvas: p,
        ...
        var Q = function (a) {
            ...
            var c, f = a.dataGenerator || function () {
                ...
                t = function (b, c, d) {
                    ...
                    if (a.drop && (e = a.drop.apply(this, arguments) !== !1), e) {
                        var g = l.getJsPlumb(), h = m.jsPlumb.getDragObject(arguments), i = g.getOffset(d ? F : h, !0),
                            o = y.mapLocation(i.left, i.top), p = j ? j(h, b, d, o) : null, q = f ? f(p, h, b, o) : {},
                ...
                }, w = d.dragEvents[h.start], x = d.dragEvents[h.drag], z = d.dragEvents[h.stop], A = d.dragEvents[h.drop],
                B = function () {
    ...
    c.Miniview = function (a) {
        ...
        }), o.bind(h.relayout, b), o.bind(h.objectRepainted, R), o.bind(h.stateRestored, b), o.bind(h.nodeVisibility, U), a.toolkit.bind(h.graphClearStart, T);
        var V = function () {
            K(!0)
        };
        m.getLayout().bind(h.redraw, V), this.setHostLayout = function (a) {
            var b = m.getLayout();
            b && b.setHostLayout(a)
    ...
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n = this, o = n.jsPlumb, p = n.Rotors, q = {},
        r = {ok: "确定", cancel: "取消"}, s = document.body, t = !1, u = p.newInstance({
    ...
    var y = function (a) {
        if (f.innerHTML = "", a.buttons) for (var b, c = 0; c < a.buttons.length; c++) b = a.buttons[c], f.appendChild(b), "true" === b.getAttribute("jtk-commit") ? o.on(b, "click", function () {
            ...
            M(!0)
        }); else l = document.createElement("button"), l.className = "jtk-dialog-button btn btn-success jtk-dialog-button-ok", l.innerHTML = r.ok, f.appendChild(l), o.on(l, "click", function () {
            M()
        }), m = document.createElement("button"), m.className = "jtk-dialog-button btn btn-danger jtk-dialog-button-cancel", m.innerHTML = r.cancel, m.setAttribute("jtk-cancel", "true"), f.appendChild(m), o.on(m, "click", function () {
            M(!0)
    ...
    a.jsPlumbToolkit.DrawingTools = function (a) {
        var b, c, d, e, f, g, h, i, j, k = a.renderer, l = k.getToolkit(), m = k.getJsPlumb(), n = {},
            ...
            r = a.topAttribute || "top", s = function () {
                ...
                if (b && (e.className = b), c && c.appendChild(e),
                        d) for (var f in d) e.setAttribute(f, d[f]);
                return e
            }, u = function (a) {
                var b = n[a];
